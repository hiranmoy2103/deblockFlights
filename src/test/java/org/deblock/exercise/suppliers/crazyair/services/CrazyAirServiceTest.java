package org.deblock.exercise.suppliers.crazyair.services;
...
public class CrazyAirServiceTest {
    ...
    public void crazyAirSearchTest() {
        List<CrazyAirResponse> crazyAirResponse = crazyAirService.getFlights("DEL", "LHR", "01-08-2022", "10-08-2022", "2");
