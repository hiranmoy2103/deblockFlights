package org.deblock.exercise.common.toughjet.domain;
...
public class ToughJetResponse {
    ...
    public String getOutboundTrimDate() {
        return DateHelpers.getDateFromStringDateTime(outboundDateTime);
    }
    
    public String getInboundTrimDate() {
        return DateHelpers.getDateFromStringDateTime(inboundDateTime);
    }
