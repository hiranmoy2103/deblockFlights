package org.deblock.exercise.common.crazyair.domain;
...
public class CrazyAirResponse {
    ...
    public String getDepartureTrimDate() {
        return DateHelpers.getDateFromStringDateTime(departureDate);
    }
    
    public String getArrivalTrimDate() {
        return DateHelpers.getDateFromStringDateTime(arrivalDate);
    }
}
